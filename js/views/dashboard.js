  ...
  container.innerHTML = `
    <div class="page-header">
      <div class="page-title-group">
        ...
        <div class="page-subtitle">📍 ${trip.destination} • 📅 ${formatDate(trip.startDate)} al ${formatDate(trip.endDate)} (${duration} días)</div>
      </div>
      <div class="header-actions">
        <button class="btn btn-secondary" id="btn-quick-summary">📌 Resumen Completo</button>
      </div>
    </div>
    ...
    <div class="card" style="margin-bottom: 1.5rem;">
      <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.75rem;">
        <h3 style="font-size: 1.1rem;">Presupuesto & Gastos</h3>
    ...
    <div class="grid-2" style="margin-bottom: 1.5rem;">
      ...
      <div class="card card-interactive" id="card-next-activity">
        ...
        ${nextActivity ? `
          ...
          <div style="color: var(--text-muted); font-size: 0.85rem;">⏰ ${nextActivity.time} • 📍 ${nextActivity.location}</div>
      ...
      <div class="card card-interactive" id="card-next-reservation">
        ...
        ${nextReservation ? `
          ...
          <div style="color: var(--text-muted); font-size: 0.85rem;">🔖 ${nextReservation.type} • Conf: #${nextReservation.confirmationNo || 'S/N'}</div>
          <div style="margin-top: 0.75rem; font-size: 0.8rem; color: var(--text-dim);">📍 ${nextReservation.address || ''}</div>
        ` : `
